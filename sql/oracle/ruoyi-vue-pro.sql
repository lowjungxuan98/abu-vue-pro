...
-- ----------------------------
-- @formatter:off
INSERT INTO system_dept (id, name, parent_id, sort, leader_user_id, phone, email, status, creator, create_time, updater, update_time, deleted, tenant_id) VALUES (100, '阿布源码', 0, 0, 1, '15888888888', 'ry@qq.com', 0, 'admin', to_date('2021-01-05 17:03:47', 'SYYYY-MM-DD HH24:MI:SS'), '1', to_date('2023-11-14 23:30:36', 'SYYYY-MM-DD HH24:MI:SS'), '0', 1);
...
INSERT INTO system_notice (id, title, content, type, status, creator, create_time, updater, update_time, deleted, tenant_id) VALUES (2, '维护通知：2018-07-01 系统凌晨维护', '<p><img src="http://test.abu.iocoder.cn/b7cb3cf49b4b3258bf7309a09dd2f4e5.jpg" alt="" data-href="" style=""/>11112222</p>', 2, 1, 'admin', to_date('2021-01-05 17:03:48', 'SYYYY-MM-DD HH24:MI:SS'), '1', to_date('2023-12-02 20:07:26', 'SYYYY-MM-DD HH24:MI:SS'), '0', 1);
...
-- ----------------------------
-- @formatter:off
INSERT INTO system_oauth2_client (id, client_id, secret, name, logo, description, status, access_token_validity_seconds, refresh_token_validity_seconds, redirect_uris, authorized_grant_types, scopes, auto_approve_scopes, authorities, resource_ids, additional_information, creator, create_time, updater, update_time, deleted) VALUES (1, 'default', 'admin123', '阿布源码', 'http://test.abu.iocoder.cn/a5e2e244368878a366b516805a4aabf1.png', '我是描述', 0, 1800, 2592000, '["https://www.iocoder.cn","https://doc.iocoder.cn"]', '["password","authorization_code","implicit","refresh_token"]', '["user.read","user.write"]', '[]', '["user.read","user.write"]', '[]', '{}', '1', to_date('2022-05-11 21:47:12', 'SYYYY-MM-DD HH24:MI:SS'), '1', to_date('2024-02-22 16:31:52', 'SYYYY-MM-DD HH24:MI:SS'), '0');
INSERT INTO system_oauth2_client (id, client_id, secret, name, logo, description, status, access_token_validity_seconds, refresh_token_validity_seconds, redirect_uris, authorized_grant_types, scopes, auto_approve_scopes, authorities, resource_ids, additional_information, creator, create_time, updater, update_time, deleted) VALUES (40, 'test', 'test2', 'biubiu', 'http://test.abu.iocoder.cn/277a899d573723f1fcdfb57340f00379.png', '啦啦啦啦', 0, 1800, 43200, '["https://www.iocoder.cn"]', '["password","authorization_code","implicit"]', '["user_info","projects"]', '["user_info"]', '[]', '[]', '{}', '1', to_date('2022-05-12 00:28:20', 'SYYYY-MM-DD HH24:MI:SS'), '1', to_date('2023-12-02 21:01:01', 'SYYYY-MM-DD HH24:MI:SS'), '0');
...
-- ----------------------------
-- @formatter:off
INSERT INTO system_users (id, username, password, nickname, remark, dept_id, post_ids, email, mobile, sex, avatar, status, login_ip, login_date, creator, create_time, updater, update_time, deleted, tenant_id) VALUES (1, 'admin', '$2a$10$mRMIYLDtRHlf6.9ipiqH1.Z.bh/R9dO9d5iHiGYPigi6r5KOoR2Wm', '阿布源码', '管理员', 103, '[1]', 'aoteman@126.com', '18818260277', 2, 'http://test.abu.iocoder.cn/96c787a2ce88bf6d0ce3cd8b6cf5314e80e7703cd41bf4af8cd2e2909dbd6b6d.png', 0, '0:0:0:0:0:0:0:1', to_date('2024-04-29 21:50:32', 'SYYYY-MM-DD HH24:MI:SS'), 'admin', to_date('2021-01-05 17:03:47', 'SYYYY-MM-DD HH24:MI:SS'), NULL, to_date('2024-04-29 21:50:32', 'SYYYY-MM-DD HH24:MI:SS'), '0', 1);
INSERT INTO system_users (id, username, password, nickname, remark, dept_id, post_ids, email, mobile, sex, avatar, status, login_ip, login_date, creator, create_time, updater, update_time, deleted, tenant_id) VALUES (100, 'abu', '$2a$10$11U48RhyJ5pSBYWSn12AD./ld671.ycSzJHbyrtpeoMeYiw31eo8a', '芋道', '不要吓我', 104, '[1]', 'abu@iocoder.cn', '15601691300', 1, '', 1, '127.0.0.1', to_date('2022-07-09 23:03:33', 'SYYYY-MM-DD HH24:MI:SS'), '', to_date('2021-01-07 09:07:17', 'SYYYY-MM-DD HH24:MI:SS'), NULL, to_date('2022-07-09 23:03:33', 'SYYYY-MM-DD HH24:MI:SS'), '0', 1);
...
-- ----------------------------
-- Table structure for abu_demo01_contact
-- ----------------------------
CREATE TABLE abu_demo01_contact
(
    id          number                                  NOT NULL,
    name        varchar2(100) DEFAULT ''                NULL,
...
ALTER TABLE abu_demo01_contact
    ADD CONSTRAINT pk_abu_demo01_contact PRIMARY KEY (id);

COMMENT ON COLUMN abu_demo01_contact.id IS '编号';
COMMENT ON COLUMN abu_demo01_contact.name IS '名字';
COMMENT ON COLUMN abu_demo01_contact.sex IS '性别';
COMMENT ON COLUMN abu_demo01_contact.birthday IS '出生年';
COMMENT ON COLUMN abu_demo01_contact.description IS '简介';
COMMENT ON COLUMN abu_demo01_contact.avatar IS '头像';
COMMENT ON COLUMN abu_demo01_contact.creator IS '创建者';
COMMENT ON COLUMN abu_demo01_contact.create_time IS '创建时间';
COMMENT ON COLUMN abu_demo01_contact.updater IS '更新者';
COMMENT ON COLUMN abu_demo01_contact.update_time IS '更新时间';
COMMENT ON COLUMN abu_demo01_contact.deleted IS '是否删除';
COMMENT ON COLUMN abu_demo01_contact.tenant_id IS '租户编号';
COMMENT ON TABLE abu_demo01_contact IS '示例联系人表';

-- ----------------------------
-- Records of abu_demo01_contact
-- ----------------------------
-- @formatter:off
INSERT INTO abu_demo01_contact (id, name, sex, birthday, description, avatar, creator, create_time, updater, update_time, deleted, tenant_id) VALUES (1, '土豆', 2, to_date('2023-11-07 00:00:00', 'SYYYY-MM-DD HH24:MI:SS'), '<p>天蚕土豆！呀</p>', 'http://127.0.0.1:48080/admin-api/infra/file/4/get/46f8fa1a37db3f3960d8910ff2fe3962ab3b2db87cf2f8ccb4dc8145b8bdf237.jpeg', '1', to_date('2023-11-15 23:34:30', 'SYYYY-MM-DD HH24:MI:SS'), '1', to_date('2023-11-15 23:47:39', 'SYYYY-MM-DD HH24:MI:SS'), '0', 1);
COMMIT;
-- @formatter:on

CREATE SEQUENCE abu_demo01_contact_seq
    START WITH 2;

-- ----------------------------
-- Table structure for abu_demo02_category
-- ----------------------------
CREATE TABLE abu_demo02_category
(
    id          number                                  NOT NULL,
    name        varchar2(100) DEFAULT ''                NULL,
...
ALTER TABLE abu_demo02_category
    ADD CONSTRAINT pk_abu_demo02_category PRIMARY KEY (id);

COMMENT ON COLUMN abu_demo02_category.id IS '编号';
COMMENT ON COLUMN abu_demo02_category.name IS '名字';
COMMENT ON COLUMN abu_demo02_category.parent_id IS '父级编号';
COMMENT ON COLUMN abu_demo02_category.creator IS '创建者';
COMMENT ON COLUMN abu_demo02_category.create_time IS '创建时间';
COMMENT ON COLUMN abu_demo02_category.updater IS '更新者';
COMMENT ON COLUMN abu_demo02_category.update_time IS '更新时间';
COMMENT ON COLUMN abu_demo02_category.deleted IS '是否删除';
COMMENT ON COLUMN abu_demo02_category.tenant_id IS '租户编号';
COMMENT ON TABLE abu_demo02_category IS '示例分类表';

-- ----------------------------
-- Records of abu_demo02_category
-- ----------------------------
-- @formatter:off
INSERT INTO abu_demo02_category (id, name, parent_id, creator, create_time, updater, update_time, deleted, tenant_id) VALUES (1, '土豆', 0, '1', to_date('2023-11-15 23:34:30', 'SYYYY-MM-DD HH24:MI:SS'), '1', to_date('2023-11-16 20:24:23', 'SYYYY-MM-DD HH24:MI:SS'), '0', 1);
INSERT INTO abu_demo02_category (id, name, parent_id, creator, create_time, updater, update_time, deleted, tenant_id) VALUES (2, '番茄', 0, '1', to_date('2023-11-16 20:24:00', 'SYYYY-MM-DD HH24:MI:SS'), '1', to_date('2023-11-16 20:24:15', 'SYYYY-MM-DD HH24:MI:SS'), '0', 1);
INSERT INTO abu_demo02_category (id, name, parent_id, creator, create_time, updater, update_time, deleted, tenant_id) VALUES (3, '怪怪', 0, '1', to_date('2023-11-16 20:24:32', 'SYYYY-MM-DD HH24:MI:SS'), '1', to_date('2023-11-16 20:24:32', 'SYYYY-MM-DD HH24:MI:SS'), '0', 1);
INSERT INTO abu_demo02_category (id, name, parent_id, creator, create_time, updater, update_time, deleted, tenant_id) VALUES (4, '小番茄', 2, '1', to_date('2023-11-16 20:24:39', 'SYYYY-MM-DD HH24:MI:SS'), '1', to_date('2023-11-16 20:24:39', 'SYYYY-MM-DD HH24:MI:SS'), '0', 1);
INSERT INTO abu_demo02_category (id, name, parent_id, creator, create_time, updater, update_time, deleted, tenant_id) VALUES (5, '大番茄', 2, '1', to_date('2023-11-16 20:24:46', 'SYYYY-MM-DD HH24:MI:SS'), '1', to_date('2023-11-16 20:24:46', 'SYYYY-MM-DD HH24:MI:SS'), '0', 1);
INSERT INTO abu_demo02_category (id, name, parent_id, creator, create_time, updater, update_time, deleted, tenant_id) VALUES (6, '11', 3, '1', to_date('2023-11-24 19:29:34', 'SYYYY-MM-DD HH24:MI:SS'), '1', to_date('2023-11-24 19:29:34', 'SYYYY-MM-DD HH24:MI:SS'), '0', 1);
COMMIT;
-- @formatter:on

CREATE SEQUENCE abu_demo02_category_seq
    START WITH 7;

-- ----------------------------
-- Table structure for abu_demo03_course
-- ----------------------------
CREATE TABLE abu_demo03_course
(
    id          number                                  NOT NULL,
...
ALTER TABLE abu_demo03_course
    ADD CONSTRAINT pk_abu_demo03_course PRIMARY KEY (id);

COMMENT ON COLUMN abu_demo03_course.id IS '编号';
COMMENT ON COLUMN abu_demo03_course.student_id IS '学生编号';
COMMENT ON COLUMN abu_demo03_course.name IS '名字';
COMMENT ON COLUMN abu_demo03_course.score IS '分数';
COMMENT ON COLUMN abu_demo03_course.creator IS '创建者';
COMMENT ON COLUMN abu_demo03_course.create_time IS '创建时间';
COMMENT ON COLUMN abu_demo03_course.updater IS '更新者';
COMMENT ON COLUMN abu_demo03_course.update_time IS '更新时间';
COMMENT ON COLUMN abu_demo03_course.deleted IS '是否删除';
COMMENT ON COLUMN abu_demo03_course.tenant_id IS '租户编号';
COMMENT ON TABLE abu_demo03_course IS '学生课程表';

-- ----------------------------
-- Records of abu_demo03_course
-- ----------------------------
-- @formatter:off
INSERT INTO abu_demo03_course (id, student_id, name, score, creator, create_time, updater, update_time, deleted, tenant_id) VALUES (2, 2, '语文', 66, '1', to_date('2023-11-16 23:21:49', 'SYYYY-MM-DD HH24:MI:SS'), '1', to_date('2023-11-16 23:21:49', 'SYYYY-MM-DD HH24:MI:SS'), '0', 1);
INSERT INTO abu_demo03_course (id, student_id, name, score, creator, create_time, updater, update_time, deleted, tenant_id) VALUES (3, 2, '数学', 22, '1', to_date('2023-11-16 23:21:49', 'SYYYY-MM-DD HH24:MI:SS'), '1', to_date('2023-11-16 23:21:49', 'SYYYY-MM-DD HH24:MI:SS'), '0', 1);
INSERT INTO abu_demo03_course (id, student_id, name, score, creator, create_time, updater, update_time, deleted, tenant_id) VALUES (6, 5, '体育', 23, '1', to_date('2023-11-16 23:22:46', 'SYYYY-MM-DD HH24:MI:SS'), '1', to_date('2023-11-16 15:44:40', 'SYYYY-MM-DD HH24:MI:SS'), '1', 1);
INSERT INTO abu_demo03_course (id, student_id, name, score, creator, create_time, updater, update_time, deleted, tenant_id) VALUES (7, 5, '计算机', 11, '1', to_date('2023-11-16 23:22:46', 'SYYYY-MM-DD HH24:MI:SS'), '1', to_date('2023-11-16 15:44:40', 'SYYYY-MM-DD HH24:MI:SS'), '1', 1);
INSERT INTO abu_demo03_course (id, student_id, name, score, creator, create_time, updater, update_time, deleted, tenant_id) VALUES (8, 5, '体育', 23, '1', to_date('2023-11-16 23:22:46', 'SYYYY-MM-DD HH24:MI:SS'), '1', to_date('2023-11-16 15:47:09', 'SYYYY-MM-DD HH24:MI:SS'), '1', 1);
INSERT INTO abu_demo03_course (id, student_id, name, score, creator, create_time, updater, update_time, deleted, tenant_id) VALUES (9, 5, '计算机', 11, '1', to_date('2023-11-16 23:22:46', 'SYYYY-MM-DD HH24:MI:SS'), '1', to_date('2023-11-16 15:47:09', 'SYYYY-MM-DD HH24:MI:SS'), '1', 1);
INSERT INTO abu_demo03_course (id, student_id, name, score, creator, create_time, updater, update_time, deleted, tenant_id) VALUES (10, 5, '体育', 23, '1', to_date('2023-11-16 23:22:46', 'SYYYY-MM-DD HH24:MI:SS'), '1', to_date('2023-11-16 23:47:10', 'SYYYY-MM-DD HH24:MI:SS'), '0', 1);
INSERT INTO abu_demo03_course (id, student_id, name, score, creator, create_time, updater, update_time, deleted, tenant_id) VALUES (11, 5, '计算机', 11, '1', to_date('2023-11-16 23:22:46', 'SYYYY-MM-DD HH24:MI:SS'), '1', to_date('2023-11-16 23:47:10', 'SYYYY-MM-DD HH24:MI:SS'), '0', 1);
INSERT INTO abu_demo03_course (id, student_id, name, score, creator, create_time, updater, update_time, deleted, tenant_id) VALUES (12, 2, '电脑', 33, '1', to_date('2023-11-17 00:20:42', 'SYYYY-MM-DD HH24:MI:SS'), '1', to_date('2023-11-16 16:20:45', 'SYYYY-MM-DD HH24:MI:SS'), '1', 1);
INSERT INTO abu_demo03_course (id, student_id, name, score, creator, create_time, updater, update_time, deleted, tenant_id) VALUES (13, 9, '滑雪', 12, '1', to_date('2023-11-17 13:13:20', 'SYYYY-MM-DD HH24:MI:SS'), '1', to_date('2023-11-17 13:13:20', 'SYYYY-MM-DD HH24:MI:SS'), '0', 1);
COMMIT;
-- @formatter:on

CREATE SEQUENCE abu_demo03_course_seq
    START WITH 14;

-- ----------------------------
-- Table structure for abu_demo03_grade
-- ----------------------------
CREATE TABLE abu_demo03_grade
(
    id          number                                  NOT NULL,
    student_id  number                                  NOT NULL,
    name        varchar2(100) DEFAULT ''                NULL,
...
ALTER TABLE abu_demo03_grade
    ADD CONSTRAINT pk_abu_demo03_grade PRIMARY KEY (id);

COMMENT ON COLUMN abu_demo03_grade.id IS '编号';
COMMENT ON COLUMN abu_demo03_grade.student_id IS '学生编号';
COMMENT ON COLUMN abu_demo03_grade.name IS '名字';
COMMENT ON COLUMN abu_demo03_grade.teacher IS '班主任';
COMMENT ON COLUMN abu_demo03_grade.creator IS '创建者';
COMMENT ON COLUMN abu_demo03_grade.create_time IS '创建时间';
COMMENT ON COLUMN abu_demo03_grade.updater IS '更新者';
COMMENT ON COLUMN abu_demo03_grade.update_time IS '更新时间';
COMMENT ON COLUMN abu_demo03_grade.deleted IS '是否删除';
COMMENT ON COLUMN abu_demo03_grade.tenant_id IS '租户编号';
COMMENT ON TABLE abu_demo03_grade IS '学生班级表';

-- ----------------------------
-- Records of abu_demo03_grade
-- ----------------------------
-- @formatter:off
INSERT INTO abu_demo03_grade (id, student_id, name, teacher, creator, create_time, updater, update_time, deleted, tenant_id) VALUES (7, 2, '三年 2 班', '周杰伦', '1', to_date('2023-11-16 23:21:49', 'SYYYY-MM-DD HH24:MI:SS'), '1', to_date('2023-11-16 23:21:49', 'SYYYY-MM-DD HH24:MI:SS'), '0', 1);
INSERT INTO abu_demo03_grade (id, student_id, name, teacher, creator, create_time, updater, update_time, deleted, tenant_id) VALUES (8, 5, '华为', '遥遥领先', '1', to_date('2023-11-16 23:22:46', 'SYYYY-MM-DD HH24:MI:SS'), '1', to_date('2023-11-16 23:47:10', 'SYYYY-MM-DD HH24:MI:SS'), '0', 1);
INSERT INTO abu_demo03_grade (id, student_id, name, teacher, creator, create_time, updater, update_time, deleted, tenant_id) VALUES (9, 9, '小图', '小娃111', '1', to_date('2023-11-17 13:10:23', 'SYYYY-MM-DD HH24:MI:SS'), '1', to_date('2023-11-17 13:10:23', 'SYYYY-MM-DD HH24:MI:SS'), '0', 1);
COMMIT;
-- @formatter:on

CREATE SEQUENCE abu_demo03_grade_seq
    START WITH 10;

-- ----------------------------
-- Table structure for abu_demo03_student
-- ----------------------------
CREATE TABLE abu_demo03_student
(
    id          number                                  NOT NULL,
    name        varchar2(100) DEFAULT ''                NULL,
    sex         smallint                                NOT NULL,
...
ALTER TABLE abu_demo03_student
    ADD CONSTRAINT pk_abu_demo03_student PRIMARY KEY (id);

COMMENT ON COLUMN abu_demo03_student.id IS '编号';
COMMENT ON COLUMN abu_demo03_student.name IS '名字';
COMMENT ON COLUMN abu_demo03_student.sex IS '性别';
COMMENT ON COLUMN abu_demo03_student.birthday IS '出生日期';
COMMENT ON COLUMN abu_demo03_student.description IS '简介';
COMMENT ON COLUMN abu_demo03_student.creator IS '创建者';
COMMENT ON COLUMN abu_demo03_student.create_time IS '创建时间';
COMMENT ON COLUMN abu_demo03_student.updater IS '更新者';
COMMENT ON COLUMN abu_demo03_student.update_time IS '更新时间';
COMMENT ON COLUMN abu_demo03_student.deleted IS '是否删除';
COMMENT ON COLUMN abu_demo03_student.tenant_id IS '租户编号';
COMMENT ON TABLE abu_demo03_student IS '学生表';

-- ----------------------------
-- Records of abu_demo03_student
-- ----------------------------
-- @formatter:off
INSERT INTO abu_demo03_student (id, name, sex, birthday, description, creator, create_time, updater, update_time, deleted, tenant_id) VALUES (2, '小白', 1, to_date('2023-11-16 00:00:00', 'SYYYY-MM-DD HH24:MI:SS'), '<p>厉害</p>', '1', to_date('2023-11-16 23:21:49', 'SYYYY-MM-DD HH24:MI:SS'), '1', to_date('2023-11-17 16:49:06', 'SYYYY-MM-DD HH24:MI:SS'), '0', 1);
INSERT INTO abu_demo03_student (id, name, sex, birthday, description, creator, create_time, updater, update_time, deleted, tenant_id) VALUES (5, '大黑', 2, to_date('2023-11-13 00:00:00', 'SYYYY-MM-DD HH24:MI:SS'), '<p>你在教我做事?</p>', '1', to_date('2023-11-16 23:22:46', 'SYYYY-MM-DD HH24:MI:SS'), '1', to_date('2023-11-17 16:49:07', 'SYYYY-MM-DD HH24:MI:SS'), '0', 1);
INSERT INTO abu_demo03_student (id, name, sex, birthday, description, creator, create_time, updater, update_time, deleted, tenant_id) VALUES (9, '小花', 1, to_date('2023-11-07 00:00:00', 'SYYYY-MM-DD HH24:MI:SS'), '<p>哈哈哈</p>', '1', to_date('2023-11-17 00:04:47', 'SYYYY-MM-DD HH24:MI:SS'), '1', to_date('2023-11-17 16:49:08', 'SYYYY-MM-DD HH24:MI:SS'), '0', 1);
COMMIT;
-- @formatter:on

CREATE SEQUENCE abu_demo03_student_seq
    START WITH 10;
