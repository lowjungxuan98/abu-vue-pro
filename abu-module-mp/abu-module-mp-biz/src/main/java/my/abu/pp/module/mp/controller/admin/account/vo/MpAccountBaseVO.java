package my.abu.pp.module.mp.controller.admin.account.vo;
...
public class MpAccountBaseVO {
    ...
    @Schema(description = "公众号名称", requiredMode = Schema.RequiredMode.REQUIRED, example = "阿布源码")
    ...
    @Schema(description = "备注", example = "请关注阿布源码，学习技术")
