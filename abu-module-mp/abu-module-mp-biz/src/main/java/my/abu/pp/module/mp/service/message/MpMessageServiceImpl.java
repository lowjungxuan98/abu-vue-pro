package my.abu.pp.module.mp.service.message;
...
import my.abu.pp.module.mp.dal.mysql.message.MpMessageMapper;
import my.abu.pp.module.mp.enums.message.MpMessageSendFromEnum;
import my.abu.pp.module.mp.framework.mp.core.MpServiceFactory;
import my.abu.pp.module.mp.framework.mp.core.util.MpUtils;
import my.abu.pp.module.mp.service.account.MpAccountService;
import my.abu.pp.module.mp.service.material.MpMaterialService;
import my.abu.pp.module.mp.service.message.bo.MpMessageSendOutReqBO;
import my.abu.pp.module.mp.service.user.MpUserService;
...
import static my.abu.pp.module.mp.enums.ErrorCodeConstants.MESSAGE_SEND_FAIL;
