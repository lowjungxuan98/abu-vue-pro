package my.abu.pp.module.member.service.signin;
...
import my.abu.pp.module.member.dal.mysql.signin.MemberSignInRecordMapper;
...
import static my.abu.pp.module.member.enums.ErrorCodeConstants.SIGN_IN_RECORD_TODAY_EXISTS;
