package my.abu.pp.module.ai.controller.admin.knowledge.vo.knowledge;
...
public class AiKnowledgeCreateReqVO {
    ...
    @Schema(description = "知识库名称", requiredMode = Schema.RequiredMode.REQUIRED, example = "abu-vue-pro 用户指南")
    @NotBlank(message = "知识库名称不能为空")
    private String name;

    @Schema(description = "知识库描述", requiredMode = Schema.RequiredMode.REQUIRED, example = "存储 abu-vue-pro 操作文档")
