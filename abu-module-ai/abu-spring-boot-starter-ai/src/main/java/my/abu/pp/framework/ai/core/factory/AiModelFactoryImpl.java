package my.abu.pp.framework.ai.core.factory;
...
import my.abu.pp.framework.ai.config.AbuAiAutoConfiguration;
import my.abu.pp.framework.ai.config.AbuAiProperties;
...
import my.abu.pp.framework.common.util.spring.SpringUtils;
...
public class AiModelFactoryImpl implements AiModelFactory {
    ...
    public MidjourneyApi getOrCreateMidjourneyApi(String apiKey, String url) {
        ...
        return Singleton.get(cacheKey, (Func0<MidjourneyApi>) () -> {
            AbuAiProperties.MidjourneyProperties properties = SpringUtil.getBean(AbuAiProperties.class).getMidjourney();
    ...
    /**
     * 可参考 {@link AbuAiAutoConfiguration#deepSeekChatModel(AbuAiProperties)}
     */
    ...
    /**
     * 可参考 {@link AbuAiAutoConfiguration#xingHuoChatClient(AbuAiProperties)}
     */
