...
import my.abu.pp.framework.common.util.cache.CacheUtils;
...
import my.abu.pp.module.system.controller.admin.socail.vo.client.SocialClientPageReqVO;
import my.abu.pp.module.system.controller.admin.socail.vo.client.SocialClientSaveReqVO;
import my.abu.pp.module.system.dal.dataobject.social.SocialClientDO;
import my.abu.pp.module.system.dal.mysql.social.SocialClientMapper;
import my.abu.pp.module.system.dal.redis.RedisKeyConstants;
...
public class SocialClientServiceImpl implements SocialClientService {
     ...
     * 3. developer：开发版
     */
    @Value("${abu.wxa-code.env-version:release}")
     ...
     * 3. formal：正式版
     */
    @Value("${abu.wxa-subscribe-message.miniprogram-state:formal}")
