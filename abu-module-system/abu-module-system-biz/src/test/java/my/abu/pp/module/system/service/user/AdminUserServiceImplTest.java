package my.abu.pp.module.system.service.user;
...
import my.abu.pp.framework.common.util.collection.ArrayUtils;
import my.abu.pp.framework.common.util.collection.CollectionUtils;
import my.abu.pp.framework.test.core.ut.BaseDbUnitTest;
import my.abu.pp.module.infra.api.config.ConfigApi;
import my.abu.pp.module.infra.api.file.FileApi;
import my.abu.pp.module.system.controller.admin.user.vo.profile.UserProfileUpdatePasswordReqVO;
import my.abu.pp.module.system.controller.admin.user.vo.profile.UserProfileUpdateReqVO;
import my.abu.pp.module.system.controller.admin.user.vo.user.*;
import my.abu.pp.module.system.dal.dataobject.dept.DeptDO;
import my.abu.pp.module.system.dal.dataobject.dept.PostDO;
import my.abu.pp.module.system.dal.dataobject.dept.UserPostDO;
import my.abu.pp.module.system.dal.dataobject.tenant.TenantDO;
import my.abu.pp.module.system.dal.dataobject.user.AdminUserDO;
import my.abu.pp.module.system.dal.mysql.dept.UserPostMapper;
import my.abu.pp.module.system.dal.mysql.user.AdminUserMapper;
import my.abu.pp.module.system.enums.common.SexEnum;
import my.abu.pp.module.system.service.dept.DeptService;
import my.abu.pp.module.system.service.dept.PostService;
import my.abu.pp.module.system.service.permission.PermissionService;
import my.abu.pp.module.system.service.tenant.TenantService;
...
import static my.abu.pp.framework.common.util.date.LocalDateTimeUtils.buildBetweenTime;
import static my.abu.pp.framework.common.util.date.LocalDateTimeUtils.buildTime;
import static my.abu.pp.framework.common.util.object.ObjectUtils.cloneIgnoreId;
import static my.abu.pp.framework.test.core.util.AssertUtils.assertPojoEquals;
import static my.abu.pp.framework.test.core.util.AssertUtils.assertServiceException;
import static my.abu.pp.framework.test.core.util.RandomUtils.*;
import static my.abu.pp.module.system.enums.ErrorCodeConstants.*;
import static my.abu.pp.module.system.service.user.AdminUserServiceImpl.USER_INIT_PASSWORD_KEY;
...
public class AdminUserServiceImplTest extends BaseDbUnitTest {
    ...
    public void before() {
        // mock 初始化密码
        when(configApi.getConfigValueByKey(USER_INIT_PASSWORD_KEY)).thenReturn("abuyuanma");
    }
