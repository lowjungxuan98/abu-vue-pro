...
public class ProjectReactor {
    ...
    private static final String GROUP_ID = "my.abu.gg";
    private static final String ARTIFACT_ID = "abu";
    private static final String PACKAGE_NAME = "my.abu.pp";
    ...
    public static void main(String[] args) {
        ...
        // ========== 配置，需要你手动修改 ==========
        String groupIdNew = "my.abu.gg";
        String artifactIdNew = "abu";
        String packageNameNew = "my.abu.pp";
