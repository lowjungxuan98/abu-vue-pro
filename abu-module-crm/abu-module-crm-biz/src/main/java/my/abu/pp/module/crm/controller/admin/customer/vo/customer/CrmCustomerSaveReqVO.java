package my.abu.pp.module.crm.controller.admin.customer.vo.customer;

import my.abu.pp.framework.common.validation.InEnum;
import my.abu.pp.framework.common.validation.Mobile;
import my.abu.pp.framework.common.validation.Telephone;
import my.abu.pp.framework.excel.core.annotations.DictFormat;
import my.abu.pp.module.crm.enums.customer.CrmCustomerLevelEnum;
import my.abu.pp.module.crm.framework.operatelog.core.CrmCustomerIndustryParseFunction;
import my.abu.pp.module.crm.framework.operatelog.core.CrmCustomerLevelParseFunction;
import my.abu.pp.module.crm.framework.operatelog.core.CrmCustomerSourceParseFunction;
import my.abu.pp.module.crm.framework.operatelog.core.SysAreaParseFunction;
...
import static my.abu.pp.module.crm.enums.DictTypeConstants.CRM_CUSTOMER_INDUSTRY;
