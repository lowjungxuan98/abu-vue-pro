package my.abu.pp.module.crm.dal.redis.no;

import cn.hutool.core.date.DatePattern;
import cn.hutool.core.date.DateUtil;
import my.abu.pp.module.crm.dal.redis.RedisKeyConstants;
...
public class CrmNoRedisDAO {
    ...
    /**
     * 合同 {@link my.abu.pp.module.crm.dal.dataobject.contract.CrmContractDO}
     */
    public static final String CONTRACT_NO_PREFIX = "HT";

    /**
     * 回款 {@link my.abu.pp.module.crm.dal.dataobject.receivable.CrmReceivablePlanDO}
     */
