package my.abu.pp.module.iot.emq.client;

import my.abu.pp.module.iot.emq.callback.EmqxCallback;
import my.abu.pp.module.iot.emq.config.MqttConfig;
...
public class EmqxClient {
    ...
    private void createMqttClient() {
        try {
            mqttClient = new MqttClient(mqttConfig.getHostUrl(), "abu" + mqttConfig.getClientId(), new MemoryPersistence());
