...
import my.abu.pp.module.trade.controller.admin.brokerage.vo.record.BrokerageRecordPageReqVO;
import my.abu.pp.module.trade.controller.app.brokerage.vo.record.AppBrokerageProductPriceRespVO;
import my.abu.pp.module.trade.controller.app.brokerage.vo.user.AppBrokerageUserRankByPriceRespVO;
...
import my.abu.pp.module.trade.dal.mysql.brokerage.BrokerageRecordMapper;
...
import my.abu.pp.module.trade.service.brokerage.bo.UserBrokerageSummaryRespBO;
...
import static my.abu.pp.framework.common.util.collection.CollectionUtils.getMaxValue;
import static my.abu.pp.framework.common.util.collection.CollectionUtils.getMinValue;
import static my.abu.pp.framework.web.core.util.WebFrameworkUtils.getLoginUserId;
import static my.abu.pp.module.trade.enums.ErrorCodeConstants.BROKERAGE_WITHDRAW_USER_BALANCE_NOT_ENOUGH;
