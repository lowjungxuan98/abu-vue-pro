package my.abu.pp.framework.desensitize.core;

import my.abu.pp.framework.common.util.json.JsonUtils;
import my.abu.pp.framework.desensitize.core.annotation.Address;
import my.abu.pp.framework.desensitize.core.regex.annotation.EmailDesensitize;
import my.abu.pp.framework.desensitize.core.regex.annotation.RegexDesensitize;
import my.abu.pp.framework.desensitize.core.slider.annotation.*;
import lombok.Data;
...
public class DesensitizeTest {
    ...
    public void test() {
        ...
        desensitizeDemo.setNickname("阿布源码");
        ...
        desensitizeDemo.setRegex("你好，我是阿布源码");
        desensitizeDemo.setAddress("北京市海淀区上地十街10号");
        desensitizeDemo.setOrigin("阿布源码");
    ...
    public static class DesensitizeDemo {
        ...
        @RegexDesensitize(regex = "阿布源码", replacer = "*")
