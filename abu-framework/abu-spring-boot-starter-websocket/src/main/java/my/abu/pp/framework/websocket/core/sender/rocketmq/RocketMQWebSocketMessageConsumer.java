package my.abu.pp.framework.websocket.core.sender.rocketmq;
...
@RocketMQMessageListener( // 重点：添加 @RocketMQMessageListener 注解，声明消费的 topic
        topic = "${abu.websocket.sender-rocketmq.topic}",
        consumerGroup = "${abu.websocket.sender-rocketmq.consumer-group}",
