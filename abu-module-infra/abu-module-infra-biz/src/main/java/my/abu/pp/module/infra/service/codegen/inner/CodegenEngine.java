package my.abu.pp.module.infra.service.codegen.inner;
...
import my.abu.pp.framework.apilog.core.enums.OperateTypeEnum;
...
import my.abu.pp.framework.excel.core.annotations.DictFormat;
import my.abu.pp.framework.excel.core.convert.DictConvert;
import my.abu.pp.framework.excel.core.util.ExcelUtils;
import my.abu.pp.framework.mybatis.core.dataobject.BaseDO;
...
public class CodegenEngine {
    ...
    private static String vueFilePath(String path) {
        return "abu-ui-${sceneEnum.basePackage}-vue2/" + // 顶级目录
                "src/" + path;
    }
