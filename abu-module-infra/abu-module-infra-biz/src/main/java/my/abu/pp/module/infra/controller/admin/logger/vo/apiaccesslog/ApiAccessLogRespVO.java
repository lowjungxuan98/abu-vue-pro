package my.abu.pp.module.infra.controller.admin.logger.vo.apiaccesslog;

import my.abu.pp.framework.excel.core.annotations.DictFormat;
import my.abu.pp.framework.excel.core.convert.DictConvert;
import my.abu.pp.module.system.enums.DictTypeConstants;
...
public class ApiAccessLogRespVO {
    ...
    @DictFormat(my.abu.pp.module.infra.enums.DictTypeConstants.OPERATE_TYPE)
    ...
    @Schema(description = "结果提示", example = "阿布源码，牛逼！")
    @ExcelProperty("结果提示")
