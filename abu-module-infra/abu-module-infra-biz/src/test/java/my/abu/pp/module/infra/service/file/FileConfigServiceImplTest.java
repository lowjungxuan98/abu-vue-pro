...
import my.abu.pp.module.infra.framework.file.core.client.FileClient;
import my.abu.pp.module.infra.framework.file.core.client.FileClientConfig;
import my.abu.pp.module.infra.framework.file.core.client.FileClientFactory;
import my.abu.pp.module.infra.framework.file.core.client.local.LocalFileClient;
import my.abu.pp.module.infra.framework.file.core.client.local.LocalFileClientConfig;
import my.abu.pp.module.infra.framework.file.core.enums.FileStorageEnum;
import my.abu.pp.framework.test.core.ut.BaseDbUnitTest;
import my.abu.pp.module.infra.controller.admin.file.vo.config.FileConfigPageReqVO;
import my.abu.pp.module.infra.controller.admin.file.vo.config.FileConfigSaveReqVO;
import my.abu.pp.module.infra.dal.dataobject.file.FileConfigDO;
import my.abu.pp.module.infra.dal.mysql.file.FileConfigMapper;
import lombok.Data;
...
import static my.abu.pp.framework.test.core.util.RandomUtils.randomLongId;
import static my.abu.pp.framework.test.core.util.RandomUtils.randomPojo;
import static my.abu.pp.module.infra.enums.ErrorCodeConstants.FILE_CONFIG_DELETE_FAIL_MASTER;
import static my.abu.pp.module.infra.enums.ErrorCodeConstants.FILE_CONFIG_NOT_EXISTS;
...
public class FileConfigServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetFileConfigPage() {
        // mock 数据
        FileConfigDO dbFileConfig = randomFileConfigDO().setName("阿布源码")
