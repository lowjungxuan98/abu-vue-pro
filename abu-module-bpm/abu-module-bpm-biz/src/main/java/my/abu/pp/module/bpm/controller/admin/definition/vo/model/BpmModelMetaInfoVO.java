package my.abu.pp.module.bpm.controller.admin.definition.vo.model;

import my.abu.pp.framework.common.validation.InEnum;
import my.abu.pp.module.bpm.enums.definition.BpmModelFormTypeEnum;
import my.abu.pp.module.bpm.enums.definition.BpmModelTypeEnum;
 ...
 *
 * 最终，它的字段和 {@link my.abu.pp.module.bpm.dal.dataobject.definition.BpmProcessDefinitionInfoDO} 是一致的
 *
 * @author 阿布源码
 */
@Data
public class BpmModelMetaInfoVO {
    ...
    @Schema(description = "流程图标", requiredMode = Schema.RequiredMode.REQUIRED, example = "https://www.iocoder.cn/abu.jpg")
