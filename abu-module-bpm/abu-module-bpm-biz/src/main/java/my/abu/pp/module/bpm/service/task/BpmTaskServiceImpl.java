package my.abu.pp.module.bpm.service.task;
...
import my.abu.pp.framework.common.util.object.PageUtils;
import my.abu.pp.framework.web.core.util.WebFrameworkUtils;
import my.abu.pp.module.bpm.controller.admin.task.vo.task.*;
import my.abu.pp.module.bpm.convert.task.BpmTaskConvert;
import my.abu.pp.module.bpm.enums.definition.*;
import my.abu.pp.module.bpm.enums.task.BpmCommentTypeEnum;
import my.abu.pp.module.bpm.enums.task.BpmReasonEnum;
import my.abu.pp.module.bpm.enums.task.BpmTaskSignTypeEnum;
import my.abu.pp.module.bpm.enums.task.BpmTaskStatusEnum;
import my.abu.pp.module.bpm.framework.flowable.core.enums.BpmnVariableConstants;
...
import my.abu.pp.module.bpm.service.definition.BpmModelService;
import my.abu.pp.module.bpm.service.message.BpmMessageService;
import my.abu.pp.module.bpm.service.message.dto.BpmMessageSendWhenTaskTimeoutReqDTO;
...
import static my.abu.pp.module.bpm.enums.ErrorCodeConstants.*;
import static my.abu.pp.module.bpm.framework.flowable.core.enums.BpmnVariableConstants.PROCESS_INSTANCE_VARIABLE_RETURN_FLAG;
...
public class BpmTaskServiceImpl implements BpmTaskService {
    ...
    public void rejectTask(Long userId, @Valid BpmTaskRejectReqVO reqVO) {
        ...
        // 疑问：为什么要标记未通过呢？
        // 回答：例如说 A 任务被向前加签除 B 任务时，B 任务被审批不通过，此时 A 会被取消。而 abu-ui-admin-vue3 不展示“已取消”的任务，导致展示不出审批不通过的细节。
