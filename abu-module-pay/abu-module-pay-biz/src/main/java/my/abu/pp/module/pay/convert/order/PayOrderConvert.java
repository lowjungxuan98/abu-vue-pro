package my.abu.pp.module.pay.convert.order;
...
import my.abu.pp.module.pay.controller.admin.order.vo.*;
...
public interface PayOrderConvert {
    ...
    PayOrderSubmitRespVO convert(PayOrderDO order, my.abu.pp.framework.pay.core.client.dto.order.PayOrderRespDTO respDTO);
